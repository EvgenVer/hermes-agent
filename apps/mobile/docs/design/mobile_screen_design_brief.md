...
For this handoff, use the dark theme only. Do not generate light-theme screens
or light-theme component variants.
...
Use a dark-only theme for the complete handoff. Every HTML/PNG frame and shared
component variant must render in the dark theme; do not generate light-theme
screens or light-theme variants. Maintain high contrast, clear elevation, and
text/icon equivalents for every semantic state.
...
stale, and dark-theme variants where applicable:
...
3. Dark-theme variants for the shell, forms, banners, dialogs, chat, and status
   components; light-theme variants are out of scope for this handoff.
...
- [ ] Every HTML and PNG review artifact uses the dark theme; no light-theme
      screen or component variant is included.
